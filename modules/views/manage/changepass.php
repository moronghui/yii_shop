                    ...
                    <?php $form=ActiveForm::begin([
                        ...
                        <div class="form-group field-admin-adminuser">
                            <div class="span12 field-box">
                            	<?php echo $form->field($model,'adminuser')->textInput(['class'=>'span9','id'=>'admin-adminuser','readonly'=>'true']); ?>
                            	</div>
                            <p class="help-block help-block-error"></p>
                        </div>
                        <div class="form-group field-admin-adminemail">
                            <div class="span12 field-box">
                            <?php echo $form->field($model,'oldpass')->passwordInput(['class'=>'span9','id'=>'admin-adminemail']); ?>
                            </div>
                            <p class="help-block help-block-error"></p>
                        </div>
                        <div class="form-group field-admin-adminpass">
                            <div class="span12 field-box">
                            <?php echo $form->field($model,'adminpass')->passwordInput(['class'=>'span9','id'=>'admin-adminpassword']); ?>
                            </div>
                            <p class="help-block help-block-error"></p>
                        </div>
