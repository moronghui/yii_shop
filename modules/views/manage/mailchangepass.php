                ...
                <div class="span4 box">
                    <div class="content-wrap">
                        ...
                        <div class="form-group field-admin-adminpass">
                            <p class="help-block help-block-error"></p>
                            <?php echo $form->field($model,'adminpass')->passwordInput(['class'=>'span12','placeholder'=>'新密码','id'=>'admin-adminpass']) ?>
                        </div>
                        <div class="form-group field-admin-adminpass">
                            <p class="help-block help-block-error"></p>
                            <?php echo $form->field($model,'repass')->passwordInput(['class'=>'span12','placeholder'=>'确认密码','id'=>'admin-adminpass']) ?>
                        </div>
